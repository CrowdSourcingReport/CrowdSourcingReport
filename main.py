...
application=webapp2.WSGIApplication([('/', MainPageHandler),('/userDashboard', UserDashboardHandler), ('/ngoDashboard', NGODashboardHandler),('/features', FeatureHandler),('/about', AboutHandler),('/explore', ExploreHandler),('/home', HomeHandler),('/WhatWeDo', WhatWeDoHandler),('/PrivacyPolicy', PrivacyPolicyHandler),('/Faq', FaqHandler),('/TermsOfUse', TermsOfUseHandler),('/Media', MediaHandler),('/Customers', CustomersHandler), ('/signup', SignupHandler)],debug=True)
